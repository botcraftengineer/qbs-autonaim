...
Платформа поддерживает мультитенантность через workspaces:

- Один пользователь может управлять несколькими workspaces
- Каждый workspace представляет отдельную компанию
- Интеграции HH.ru и вакансии привязаны к workspace
...
Подробнее: [docs/WORKSPACE_MIGRATION.md](docs/WORKSPACE_MIGRATION.md)
