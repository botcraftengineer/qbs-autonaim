...
- [x] 9. Генератор приглашений на интервью ✅
  - [x] 9.1 Создать Inngest задачу: `freelance.invitation.generate` ✅
    - ✅ Запускается автоматически после завершения анализа (событие из task 8.1)
    - ✅ Проверяет порог оценки (MIN_SCORE_THRESHOLD = 60)
    - ✅ Генерирует персонализированный текст через GPT-4 с именем кандидата и деталями вакансии
    - ✅ Включает ссылку на интервью из таблицы `interview_links`
    - ✅ Сохраняет запись в `freelance_invitations` с временной меткой
    - ✅ Предотвращает дублирование приглашений
...
- [x] 15. Фронтенд - UI управления заданиями
  ...
  - [x] 15.3 Создать страницу деталей задания
...
- [x] 16. Фронтенд - UI ручного импорта
  - [x] 16.1 Создать компонент формы ручного импорта
  ...
  - [x] 16.2 Реализовать логику предпросмотра импорта
  ...
  - [x] 16.3 Реализовать отправку импорта
...
- [x] 17. Фронтенд - UI шортлиста
  - [x] 17.1 Создать компонент просмотра шортлиста ✅
  ...
  - [x] 17.2 Реализовать фильтрацию шортлиста ✅
    - ✅ Клиентская фильтрация по порогу оценки (0-100, шаг 5)
    - ✅ Пересортировка по различным критериям (overall score, response score, interview score, name)
    - ℹ️ Примечание: Сортировка по "опыту" не реализована, так как в модели данных shortlist response нет поля experience
    - _Требования: 8.4_

  - [x] 17.3 Реализовать экспорт шортлиста ✅
    - ✅ Генерация CSV с заголовками: Место, Имя, Общая оценка, Оценка отклика, Оценка интервью, Email, Телефон, Telegram, Ключевые особенности, Красные флаги
    - ✅ Экспорт отфильтрованных и отсортированных кандидатов
    - ✅ Использование BOM (`\uFEFF`) для корректной кодировки UTF-8
    - ✅ Экранирование кавычек в CSV данных
    - ✅ Генерация имени файла с датой: `shortlist-{vacancyId}-{date}.csv`
    - ✅ Toast уведомления об успехе/ошибке
    - ✅ Кнопка экспорта с иконкой `IconDownload`, адаптивная для мобильных (min-h-[44px])
    - ✅ Кнопка отключена, если нет данных для экспорта
    - _Требования: 8.6_

- [x] 18. Дашборд и аналитика
  - [x] 18.1 Создать страницу дашборда фриланс-платформ
  ...
  - [x] 18.5 Создать страницу аналитики
...
- [x] 19. Система уведомлений
  - [x] 19.1 Создать Inngest задачу: `freelance.notification.send`
...
- [x] 20. Безопасность и логирование аудита
  - [x] 20.1 Реализовать логирование доступа к персональным данным
  ...
  - [x] 20.3 Реализовать очистку данных при удалении задания
...
- [x] 21. Обработка ошибок и восстановление
  - [x] 21.1 Реализовать обработку ошибок для всех tRPC эндпоинтов
  ...
  - [x] 21.4 Реализовать механизмы повтора
