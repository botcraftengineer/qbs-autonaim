...
3. КОГДА начинается интервью, ТО Система ДОЛЖНА собрать базовую информацию о фрилансере (имя, контакты, URL профиля на платформе)
4. Система ДОЛЖНА проводить интервью через веб-чат в реальном времени, используя тот же AI-движок, что и интеграция с HeadHunter
5. КОГДА фрилансер отправляет сообщение, ТО Система ДОЛЖНА отобразить индикатор "бот печатает..." и доставить ответ в течение 5 секунд
6. КОГДА интервью завершено, ТО Система ДОЛЖНА отобразить подтверждающее сообщение в чате
7. Система ДОЛЖНА позволять фрилансерам проходить интервью на мобильных устройствах
8. Система ДОЛЖНА сохранять историю чата и позволять возобновить интервью при перезагрузке страницы
9. Интервью ДОЛЖНО поддерживать текстовые сообщения (голосовые сообщения - будущая функциональность)
...
### Требование 9: Управление заданиями

**Пользовательская история:** Как работодатель, я хочу управлять своими заданиями на фриланс-платформах в QBS, чтобы я мог отслеживать все действия по отбору в одном месте.

#### Критерии приемки

1. Система ДОЛЖНА позволять работодателям создавать записи заданий для любой фриланс-платформы
2. КОГДА создаётся задание, ТО Работодатель ДОЛЖЕН указать источник платформы (kwork, fl, weblancer и т.д.)
3. КОГДА создаётся задание, ТО Работодатель ДОЛЖЕН предоставить название задания, описание и требования
4. Система ДОЛЖНА сохранять URL задания на платформе для справки
5. Система ДОЛЖНА отображать статистику: всего откликов, завершённых интервью, размер шортлиста
6. Работодатель ДОЛЖЕН иметь возможность помечать задания как активные, приостановленные или закрытые
7. КОГДА задание закрыто, ТО Система ДОЛЖНА предотвратить доступ к новым ссылкам на интервью
