...
**Компоненты**:
- **Форма создания задания**: Название, описание, требования, источник платформы, URL платформы
- **Список заданий**: Отображение всех заданий на фриланс-платформах со статистикой, фильтруемых по платформе
- **Страница деталей задания**: Показ ссылки на интервью, откликов, шортлиста
- **Дашборд статистики**: Импортированные отклики, завершённые интервью, размер шортлиста

**Ключевые функции**:
- Копирование ссылки на интервью в буфер обмена
- Скачивание шаблонного текста для описания задания (платформо-независимый)
- Просмотр истории импорта откликов
- Запуск массового AI-анализа
- Экспорт шортлиста в CSV
- Фильтрация заданий по источнику платформы (Kwork, FL.ru, Weblancer и т.д.)
...
- Существующие поля естественно маппятся:
  ...
  - `resumeUrl` -> URL профиля на платформе
  - `candidateName` -> Имя фрилансера
  - `coverLetter` -> Текст отклика с платформы
