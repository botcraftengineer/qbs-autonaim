    ...
    },
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "Да, мы поддерживаем интеграцию с Авито Работа, LinkedIn, Upwork, FL.ru. Вы можете подключить несколько источников одновременно и управлять всеми откликами в едином интерфейсе.",
        },
        {
