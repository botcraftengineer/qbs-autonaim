                    ...
                    <div className="flex gap-3">
                      ...
                      <div className="flex-1 space-y-1">
                        ...
                        <p className="text-sm text-muted-foreground">
                          ...
                          создать профессиональную вакансию с разделами:
                          Описание, Требования, Обязанности, Условия и Премии.
                          Документ будет оформлен в соответствии со стандартами
                          и привлечёт качественных кандидатов.
                        </p>
                      </div>
                    </div>
                  </div>
