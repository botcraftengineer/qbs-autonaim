      ...
      <ReactMarkdown
        components={{
          ...
          code: ({ node, ...props }) => (
            <code
              {...props}
              className="rounded-md bg-neutral-100 px-1 py-0.5"
            />
          ),
        }}
      >
