...
- "Какой график работы вам подходит и какие ожидания по зарплате? Можете ответить голосовым, если удобно 🎤"
...
- "Интересный подход! Это показывает системность. А какой график вам подходит?"
