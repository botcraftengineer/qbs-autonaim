...
test.describe
  .skip("Switcher в сайдбаре", () => {
    // TODO: Эти тесты требуют специфичных селекторов которые зависят от UI
    // Нужно обновить после стабилизации UI компонентов
    ...
    test.describe("Переключение организаций", () => {
      ...
      test("открывает диалог создания организации", async ({ page }) => {
        ...
        await page
          .getByRole("menuitem", { name: /Создать организацию/ })
          .click();
