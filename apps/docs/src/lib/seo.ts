...
export const seoConfigs = {
  ...
  organizations: {
    title: "Организации в QBS Автонайм — управление командой и доступом",
    description:
      "Управление организацией в QBS Автонайм. Создание воркспейсов, приглашение участников, настройка ролей и прав доступа, управление биллингом.",
    keywords: [
      "организация QBS",
      "управление командой",
  ...
  workspaces: {
    title: "Воркспейсы — изолированные пространства для команд",
    description:
      "Воркспейсы в QBS Автонайм для организации работы команд. Создание воркспейсов, управление участниками, настройка интеграций и AI-инструментов.",
    keywords: [
      "воркспейсы QBS",
