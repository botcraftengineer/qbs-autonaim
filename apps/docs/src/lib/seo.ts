...
export const seoConfigs = {
  home: {
    ...
    keywords: [
      ...
      "HH.ru интеграция",
      "SuperJob API",
      "Telegram бот рекрутинг",
      "скрининг резюме AI",
      "интервью кандидатов",
      "HR аналитика",
      "подбор персонала РФ",
      "документация API tRPC",
      "рекрутер софт",
    ],
  },
  ...
  api: {
    title: "API QBS Автонайм — интеграция для разработчиков",
    description: "Документация REST API и tRPC для интеграции QBS Автонайм. Работа с кандидатами, вакансиями, webhooks. SDK для автоматизации HR-процессов.",
    keywords: [
      "API рекрутинга",
      "tRPC документация",
      "REST API HR",
      "интеграция ATS",
      "webhooks найм",
      "SDK подбор персонала",
      "автоматизация HR API",
    ],
  },
