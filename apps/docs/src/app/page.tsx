      ...
      <article className="docs-content flex-1 max-w-3xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-xl text-muted-foreground">
            Российская AI-платформа для автоматизации рекрутинга. Интеграция с
            HH.ru и SuperJob, Telegram-боты, экономия до 80% времени на подборе
            персонала. Используют Сбер, Тинькофф, Яндекс и 500+ компаний.
          </p>
        </div>
        ...
        <ul>
          ...
          <li>
            <strong>Рекрутер в ритейле</strong> — нанимаете продавцов и кассиров,
            получаете 200+ откликов на вакансию
          </li>
          <li>
        ...
        <p>
          <strong>Результат:</strong> Время на одну вакансию сокращается с 2 недель до 3 дней.
          Качество кандидатов растёт на 40% благодаря объективной AI-оценке.
        </p>
        ...
        <ul>
          ...
          <li>
            <Link href="/integrations/hh">📊 Интеграция с HH.ru</Link> — автоматический
            импорт вакансий и откликов, синхронизация статусов
          </li>
          <li>
            <Link href="/ai-assistant/chat">💬 Автоматические интервью</Link> — чат-боты
            проводят первичное интервью 24/7 на русском языке
          </li>
          <li>
          ...
          <li>
            <Link href="/integrations/telegram">✈️ Telegram-боты</Link> — нанимайте
            через самый популярный мессенджер в РФ
          </li>
          <li>
            <Link href="/candidates/voice">🎤 Голосовые резюме</Link> — транскрибация
            аудио через Yandex SpeechKit
          </li>
          <li>
            <Link href="/api">🔧 API для интеграций</Link> — подключайтесь к 1С,
            Bitrix24, своим HR-системам
          </li>
          <li>
            <Link href="/analytics">📈 Аналитика найма</Link> — метрики эффективности,
            ROI рекрутинга, отчёты для руководства
          </li>
        </ul>
        ...
        <div className="grid gap-4 sm:grid-cols-2 my-6">
          ...
          <DocsCard
            ...
            description="HH.ru, SuperJob, Telegram, Kwork, FL.ru — все популярные платформы России"
            href="/integrations"
            icon={<Plug className="h-5 w-5" />}
          />
          <DocsCard
            title="⚙️ API и автоматизация"
            description="Интегрируйте с 1С, Bitrix24, своими системами через современный tRPC API"
            href="/api"
        ...
        <div className="grid gap-4 sm:grid-cols-2 my-6">
          <DocsCard
            title="📝 Блог и кейсы"
            description="Истории успеха компаний из РФ, лучшие практики рекрутинга, обновления продукта"
