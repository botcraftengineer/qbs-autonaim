  ...
  const setupSteps = [
    {
      ...
      content: <p className="leading-relaxed text-foreground/80 mb-4">{"Откройте раздел «AI-ассистент» → «Автоответы» в главном меню."}</p>,
    },
    {
      title: "Создайте новое правило",
      content: <p className="leading-relaxed text-foreground/80 mb-4">{"Нажмите «Добавить правило» и выберите тип триггера (ключевые слова, событие, расписание)."}</p>,
    },
    {
      title: "Настройте условия",
      content: <p className="leading-relaxed text-foreground/80 mb-4">Укажите, при каких условиях должен срабатывать автоответ.</p>,
    },
    {
      title: "Выберите шаблон или напишите текст",
      content: <p className="leading-relaxed text-foreground/80 mb-4">Используйте готовый шаблон или создайте собственный текст ответа.</p>,
    },
  ]
  ...
  return (
    <div className="flex gap-12">
      <article className="flex-1 max-w-3xl">
        <DocsBreadcrumb items={[{ title: "AI-ассистент", href: "/ai-assistant" }, { title: "Автоответы" }]} />

        <div className="flex items-center justify-between mb-2">
          <span className="text-sm font-medium text-primary">AI-ассистент</span>
        </div>

        <h1 className="text-3xl font-bold tracking-tight text-foreground mb-4">Автоответы</h1>
        ...
        <h2 id="auto-reply-types" className="text-xl font-semibold tracking-tight text-foreground mt-10 mb-4 scroll-mt-20">Типы автоответов</h2>
        ...
        <h2 id="setup" className="text-xl font-semibold tracking-tight text-foreground mt-10 mb-4 scroll-mt-20">Настройка автоответов</h2>

        <DocsSteps steps={setupSteps} />

        <h2 id="triggers" className="text-xl font-semibold tracking-tight text-foreground mt-10 mb-4 scroll-mt-20">Триггеры автоответов</h2>

        <p className="leading-relaxed text-foreground/80 mb-4">Автоответы могут срабатывать по различным триггерам:</p>

        <ul>
          <li>
            <strong className="font-semibold text-foreground">Ключевые слова</strong> — при упоминании определённых слов в сообщении кандидата
          </li>
          <li>
            <strong className="font-semibold text-foreground">Событие</strong> — при наступлении события (новый отклик, смена статуса, назначение собеседования)
          </li>
          <li>
            <strong className="font-semibold text-foreground">Расписание</strong> — в определённое время (например, напоминание за сутки до собеседования)
          </li>
          <li>
            <strong className="font-semibold text-foreground">Бездействие</strong> — если кандидат не отвечает в течение заданного времени
          </li>
        </ul>
        ...
        <h2 id="personalization" className="text-xl font-semibold tracking-tight text-foreground mt-10 mb-4 scroll-mt-20">Персонализация</h2>

        <p className="leading-relaxed text-foreground/80 mb-4">Используйте переменные для персонализации автоответов:</p>
