  ...
  return (
    <div className="flex gap-12">
      <article className="flex-1 max-w-3xl">
        ...
        <p className="text-lg">
          Ключевые показатели эффективности (KPI) найма помогают оценить
          результативность процесса и выявить области для улучшения.
        </p>
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-border">
              ...
              <tr>
                ...
                <td className="px-4 py-3 text-muted-foreground">
                  Время от первого контакта до принятия оффера
                </td>
                <td className="px-4 py-3 text-muted-foreground">
                  Дата оффера - Дата первого отклика
                </td>
              </tr>
              <tr>
                <td className="px-4 py-3 font-medium text-foreground">
                ...
                <td className="px-4 py-3 text-muted-foreground">
                  Общие затраты / Количество наймов
                </td>
              </tr>
              <tr>
                <td className="px-4 py-3 font-medium text-foreground">
        ...
        <ul>
          <li>
            ...
            — процент кандидатов, прошедших от отклика до найма
          </li>
          <li>
            <strong className="font-semibold text-foreground">
              Источники кандидатов
            </strong>{" "}
            — количество и качество кандидатов из каждого источника
          </li>
          <li>
            <strong className="font-semibold text-foreground">
              Активность рекрутеров
            </strong>{" "}
            — количество обработанных кандидатов на рекрутера
          </li>
          <li>
            <strong className="font-semibold text-foreground">
              Скорость ответа
            </strong>{" "}
            — среднее время первого ответа кандидату
          </li>
        </ul>
        ...
        <ul>
          <li>
            ...
            — оценка качества нанятых сотрудников через 3-6 месяцев
          </li>
          <li>
            <strong className="font-semibold text-foreground">
              Retention Rate
            </strong>{" "}
            — процент сотрудников, оставшихся после испытательного срока
          </li>
          <li>
            <strong className="font-semibold text-foreground">
              Hiring Manager Satisfaction
            </strong>{" "}
            — удовлетворённость нанимающих менеджеров
          </li>
          <li>
            <strong className="font-semibold text-foreground">
              Candidate Experience
            </strong>{" "}
            — оценка процесса найма кандидатами
          </li>
        </ul>

        <DocsCallout type="info" title="Автоматический сбор">
          QBS Автонайм автоматически собирает данные для расчёта всех метрик.
          Вам не нужно вести отдельные таблицы — просто используйте систему, и
          аналитика будет доступна.
        </DocsCallout>
        ...
        <p className="leading-relaxed text-foreground/80 mb-4">
          Сравнивайте свои показатели со средними по рынку:
        </p>
