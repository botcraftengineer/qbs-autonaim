  ...
  const faqData = [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          a: "Да, платформа полностью локализована для российского рынка. AI понимает русский язык, работает с HH.ru, SuperJob и поддерживает все популярные мессенджеры РФ.",
        },
      ],
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          a: "Оплата ежемесячно или ежегодно банковской картой. Поддерживаем все популярные карты РФ (МИР, Visa, Mastercard). Есть возможность оплаты по счёту для юридических лиц.",
        },
        {
      ...
      questions: [
        {
          ...
          a: "AI анализирует резюме по 100+ критериям: опыт работы, навыки, образование, достижения. Сравнивает с требованиями вакансии и присваивает оценку от 0 до 100 баллов. Обучен на миллионе резюме из РФ.",
        },
        {
      ...
      questions: [
        {
          ...
          a: "Все данные хранятся на серверах в РФ, соответствуют требованиям 152-ФЗ «О персональных данных». Используем шифрование AES-256 и регулярные аудиты безопасности.",
        },
        {
        ...
        },
        {
          ...
          a: "При удалении аккаунта все персональные данные кандидатов анонимизируются или удаляются в течение 30 дней согласно требованиям законодательства РФ.",
        },
      ],
    },
    {
