...
export const metadata: Metadata = generatePageSEO("knowledge-base", {
  ...
  description: "База знаний по AI-рекрутингу. Статьи о лучших практиках найма, кейсы компаний, советы по работе с кандидатами. Полезные материалы для HR.",
      ...
      articles: [
        {
          ...
          description: "HH.ru + SuperJob + Telegram + сайт компании",
          readTime: "13 мин",
        },
        {
    ...
    <div className="flex gap-12">
      <article className="docs-content flex-1 max-w-3xl">
        ...
        <DocsCallout type="info" title="Хотите поделиться опытом?">
          <p>
            У вас есть интересный кейс или полезный гайд? Напишите нам —
            мы опубликуем вашу статью в базе знаний и поделимся с сообществом HR.
          </p>
          <div className="mt-3">
            <a
