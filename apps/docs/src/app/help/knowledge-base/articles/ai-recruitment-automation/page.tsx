    ...
    <div className="flex gap-12">
      <article className="flex-1 max-w-3xl">
        ...
        <p className="text-lg text-muted-foreground mb-8">
          Практическое руководство по автоматизации первичного скрининга
          кандидатов с помощью искусственного интеллекта
        </p>
        ...
        <p className="leading-relaxed text-foreground/80 mb-4">
          Средний рекрутер тратит 23 часа в неделю на просмотр резюме. При этом
          60-70% кандидатов не соответствуют базовым требованиям вакансии. Это
          означает, что большая часть времени тратится впустую.
        </p>

        <div className="my-6 rounded-lg border border-border p-6 bg-muted/30">
          <h3 className="font-semibold text-foreground mb-3">
            Типичная воронка найма:
          </h3>
          ...
          <p className="mt-4 text-sm text-muted-foreground">
            <strong>Проблема:</strong> 85% времени тратится на неподходящих
            кандидатов
          </p>
        </div>
        ...
        <p className="leading-relaxed text-foreground/80 mb-4">
          Искусственный интеллект может за секунды проанализировать резюме и
          определить соответствие кандидата требованиям вакансии. Это не
          заменяет человека, а освобождает его время для работы с действительно
        ...
        <ul className="space-y-3 mb-6">
          <li>
            ...
            — релевантность предыдущих позиций, продолжительность работы,
            карьерный рост
          </li>
          <li>
            <strong className="font-semibold text-foreground">Навыки</strong> —
            соответствие технологического стека, уровень владения инструментами
          </li>
          <li>
            <strong className="font-semibold text-foreground">
              Образование
            </strong>{" "}
            — профиль подготовки, уровень образования, дополнительные курсы
          </li>
          <li>
            <strong className="font-semibold text-foreground">
              Достижения
            </strong>{" "}
            — конкретные результаты, проекты, награды
          </li>
          <li>
            <strong className="font-semibold text-foreground">
              Красные флаги
            </strong>{" "}
            — частая смена работы, пробелы в опыте, несоответствия
          </li>
        </ul>

        <DocsCallout type="tip" title="Ключевое преимущество">
          AI работает 24/7 и обрабатывает один отклик за 3-5 секунд. Человеку на
          это требуется 10-15 минут.
        </DocsCallout>
        ...
        <div className="space-y-6 my-6">
          <div className="border-l-4 border-primary pl-6">
            <h3 className="font-semibold text-foreground mb-2">
              Шаг 1: Настройте критерии оценки
            </h3>
            <p className="text-sm text-muted-foreground mb-3">
              Определите обязательные и желательные требования для вакансии. Чем
              точнее критерии, тем лучше работает AI.
            </p>
          ...
          <div className="border-l-4 border-primary pl-6">
            <h3 className="font-semibold text-foreground mb-2">
              Шаг 2: Подключите источники кандидатов
            </h3>
            <p className="text-sm text-muted-foreground mb-3">
              Интегрируйте HH.ru, фриланс-платформы и другие источники. AI
              автоматически обработает все новые отклики.
            </p>
          </div>

          <div className="border-l-4 border-primary pl-6">
            <h3 className="font-semibold text-foreground mb-2">
              Шаг 3: Работайте только с топ-кандидатами
            </h3>
            <p className="text-sm text-muted-foreground">
              Фокусируйтесь на кандидатах с оценкой 4-5 звезд. Остальных можно
              отклонить автоматически или отложить.
            </p>
          </div>
        </div>
        ...
        <ul className="space-y-3 mb-6">
          <li>
            <strong className="font-semibold text-foreground">
              Начните с одной вакансии
            </strong>{" "}
            — протестируйте AI на самой проблемной позиции с большим потоком
            откликов
          </li>
          <li>
            <strong className="font-semibold text-foreground">
              Проверяйте первые 20-30 оценок
            </strong>{" "}
        ...
        <DocsCallout type="warning" title="Важно помнить">
          AI — это инструмент, а не замена рекрутера. Используйте его для
          рутинных задач, а освободившееся время направьте на построение
          отношений с кандидатами и улучшение candidate experience.
        </DocsCallout>
