...
export default function OrganizationInviteEmail({
  ...
  inviteLink = `${APP_CONFIG.url}/invites/token`,
  role = "member",
  ...
  return (
    <Html>
      <Head />
      <Preview>
        Приглашение в организацию {organizationName} от {inviterName}
      </Preview>
        ...
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-[40px] w-[465px] rounded border border-solid border-[#eaeaea] p-[20px]">
            ...
            <Text className="text-[14px] leading-[24px] text-black">
              ...
              организации <strong>{organizationName}</strong> в роли {roleName}.
            </Text>
            ...
            <Text className="text-[12px] leading-[24px] text-[#666666]">
              ...
              присоединяться к этой организации, просто проигнорируйте это
              письмо.
            </Text>
          </Container>
        </Body>
