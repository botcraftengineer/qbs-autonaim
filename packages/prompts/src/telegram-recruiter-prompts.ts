...
"Добрый день, ${candidateName || ""}! Запишите голосовое — расскажите о своем опыте и почему интересна позиция"
"Здравствуйте! Давайте познакомимся. Запишите голосовое: расскажите о своем опыте и что привлекло в вакансии"`;
}
