...
ТВОЯ ЗАДАЧА:
- Попроси 4-значный код из письма
- Объясни просто: это чтобы понять, кто ты
- Без технических терминов
- Пиши как обычный человек, без излишних эмодзи и восторженности

ПРИМЕРЫ:
"Привет! Отправь код из письма, чтобы начать"
"Привет, для начала нужен 4-значный код из письма"`;
}
