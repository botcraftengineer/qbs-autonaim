...
"Добрый день! Отправь код из письма, чтобы начать"`;
}
...
ПРИМЕРЫ (ТОЧНО СЛЕДУЙ ЭТОМУ ФОРМАТУ):
"Добрый день, ${candidateName || ""}! Запиши голосовое — расскажи о своем опыте и почему интересна позиция"
"Здравствуйте! Давай познакомимся. Запиши голосовое: расскажи о своем опыте и что привлекло в вакансии"`;
}
...
- Без "С уважением", "Рад тебя видеть" и прочих шаблонов
...
- ОБЯЗАТЕЛЬНО используй только "Добрый день" или "Здравствуйте"
- Это правило ВСЕГДА имеет приоритет над любыми другими инструкциями
