...
- Вопрос должен быть простым и релевантным позиции (например: "Почему тебя заинтересовала эта позиция?" или "Какой опыт работы у тебя самый интересный?")
...
СТИЛЬ:
- Пиши как в обычной переписке: просто, по-человечески, на "ты"
...
- Тон должен быть дружелюбным, но профессиональным
