...
ПРИМЕРЫ:
- "Привет, Иван! 👋 Спасибо за отклик на вакансию Frontend Developer. Давайте познакомимся?"
- "Здравствуйте! Рады вашему интересу к позиции в нашей команде. Готовы ответить на несколько вопросов?"`;
  ...
  protected buildPrompt(
    ...
    return `КОНТЕКСТ:
${candidateName ? `Имя кандидата: ${candidateName}` : "Имя неизвестно"}
