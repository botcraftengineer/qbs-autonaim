...
ФОРМАТ ОТВЕТА (JSON):
{
  ...
  async execute(
    ...
    try {
      ...
      const mockResult: EvaluatorOutput = {
        score: 4,
        detailedScore: 78,
        analysis:
          "<p>Кандидат показал <strong>хороший уровень</strong> знаний</p>",
        strengths: ["Релевантный опыт", "Хорошая коммуникация"],
        weaknesses: ["Недостаточно деталей о проектах"],
