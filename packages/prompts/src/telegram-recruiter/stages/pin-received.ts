...
- Если кандидат просит отложить: "Хорошо, жду ваших ответов. Напишите, когда будете готовы 🙂"
...
- Если кандидат пишет что ответит позже - подтверди это дружелюбно и коротко`;
}
