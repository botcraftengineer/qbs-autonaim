...
Если ты УЖЕ задал организационные вопросы в предыдущем сообщении, а кандидат прислал:
...
Это означает, что кандидат просто поздоровался в ответ, но еще не дал ответы на вопросы.
...
- Если кандидат не хочет: "Можете ответить текстом, но голосом быстрее 🙂"
- Если просит отложить: "Хорошо, жду ваших ответов. Напишите, когда будете готовы 🙂"`;
}
