...
- "Добрый день, Алексей! Подскажите, какой график вам подходит, какие ожидания по зарплате? Если удобно — запишите голосовое, так быстрее 🙂"
- "Здравствуйте, Мария! Давайте обсудим детали. Расскажите про желаемый график и зарплату? (можно голосовым или текстом)"
- "Добрый день! Подскажите, какой график вам подходит, какие ожидания по зарплате? Если удобно — запишите голосовое, так быстрее 🙂" (если имя неизвестно)`;
...
ТВОЯ ЗАДАЧА:
${alreadyGreeted ? "- НЕ здоровайся заново! Кандидат уже поздоровался" : `- Поприветствуй кандидата естественно${name ? ` (обращайся "${name}")` : " (без имени)"}`}
