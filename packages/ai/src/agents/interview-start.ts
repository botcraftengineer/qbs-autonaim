...
- "Добрый день, Алексей! Какой график работы вам подходит? Можете ответить голосовым, если удобно 🎤"
- "Здравствуйте, Мария! Расскажите про желаемый график и зарплату?"
- "Добрый день! Какой график вам подходит?" (если имя неизвестно)
