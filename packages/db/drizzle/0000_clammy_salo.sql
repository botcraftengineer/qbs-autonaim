...
CREATE TYPE "public"."hr_selection_status" AS ENUM('INVITE', 'RECOMMENDED', 'NOT_RECOMMENDED', 'REJECTED', 'OFFER');--> statement-breakpoint
CREATE TYPE "public"."response_status" AS ENUM('NEW', 'EVALUATED', 'DIALOG_APPROVED', 'INTERVIEW_HH', 'COMPLETED', 'SKIPPED');--> statement-breakpoint
