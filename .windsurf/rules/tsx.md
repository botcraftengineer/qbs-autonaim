...
---
   1. Именование и стиль кода:
        ...
        4. Управление состоянием и получение данных:
           ...
           - Реализовывать правильные состояния загрузки и ошибок
           - Для AI запросов использовать streaming с индикаторами загрузки
           - Кэшировать AI ответы для улучшения UX
        ...
        9. Управление монорепозиторием и рабочим пространством:
           - Правильно использовать ссылки на рабочее пространство (пакеты @qbs-autonaim/*)
        ...
        11. Интеграция с AI и чатами:
            - Использовать streaming для длинных AI ответов
            - Показывать индикаторы загрузки при генерации контента
            - Реализовывать graceful degradation при ошибках AI
            - Валидировать все входные данные перед отправкой в AI
            - Ограничивать длину сообщений и количество токенов
            - Предотвращать спам-запросы с помощью rate limiting
            - Логировать взаимодействия с AI для отладки
            - Использовать optimistic updates для лучшего UX
            - Предлагать быстрые ответы для распространенных сценариев
            - Правильно обрабатывать состояния чата (typing, error, completed)